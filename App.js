...
export default function App(){
  ...
  const [coinsGraphichList, setcoinsGraphichList] = useState([0]);
  ...
  function priceCotation(){
    setPrice(coinsGraphichList.pop());
    }
...
return (
    <SafeAreaView style={styles.container}>
      ...
      <HistoryGraphic infoDataGraphic={coinsGraphichList} />
      <QuotationsList 
          filterDay={updateDay} 
